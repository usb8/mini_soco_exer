...
.venv\Scripts\activate  # source .venv/bin/activate (for Linux CLI)  # py -3.11 -m venv .venv
  deactivate
...
- Before running app, need to create a new table for post reports once. You can you add_post_reports.py for convenience
